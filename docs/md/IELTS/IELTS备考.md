...
1. 口语：12分钟左右。考试采用一对一的面试形式，考察考生日常会话、对熟悉话题作一定长度的描述以及与考官之间的互动能力。
...
2. 听力：30分钟听4段录音，每段10道题，共40道题，难度递增。前3段录音分两次听完，段内（第1-3篇）会给两次读题的机会（没仔细算过，可能是30秒左右），一段听完会有30秒时间检查答案。录音只听一遍。全部4段听完有10分钟抄答案，听力共40分钟



3. 培训类阅读：60分钟读3篇文章，共40道题（14+13+13），难度递增。考试的文章以英语国家日常生活素材为基础，可能从报纸、广告、说明书及书籍中摘取，考察考生对信息的理解及运用的能力。试题包括一篇较长的描述性、而非论证性的文章。



4. 培训类写作：60分钟写2篇文章，一篇小作文（20分钟，>150词）和一篇大作文（40分钟，>250词）
...
另，每年的1、5、9月份官方会撤换掉一部分上季度的题，并换入一部分新的题。理论上，题库中的所有题目都是已经公开并且可以穷尽看一遍的。
...
推荐有心提高口语的同学按照话题安排学习掌握语汇。然后，备考前夕，可以下载当季真题全部看一遍，做到心中有数。雅思口语会在每年1、5、9月撤换部分旧题、换上部分新题。由于其话题库总是保持相对稳定的，并且其过往考题完全公开，因此理论上通过穷举地准备当季考题+上季旧题，完全可以达到极高的押题命中率。考前一周按照[这个真题库](http://ielts.xdf.cn/202101/11141941.html)查缺补漏。

### Part I

Part 1较为轻松，回答**清晰、直接**即可，切勿长篇大论，正常情况下直接回答1句+稍微解释1句就行，再多也不要超过3句，否则会占用后面考试时间，减少发挥机会。

Part 1有些比较正常的询问个人情况的考题，请见附录[Part 1过往真题](Part1过往真题.md)一节。
...
**I think , because . [For example, .] [... is also ]. On the other hand, it's also true that** .

对于“分析原因”和“分析利弊”型，基本回答模板如下：

**I think the main reason/advantage/benefit is . And another reason/advantage/benefit is . On the other hand(side)/Unlike ..., .**
...
> Some people think that ... . Others, however, have a different view(believe) that ... .<br>
>
...
> (Background). While some argue that ..., I tend to believe that ... . (Background). Although I agree that ..., but I think(believe) that ... .<br>
>
...
> People have different views about ... . While ... can have benefits, I believe that ... .<br>
>
>
>
...
> There are several causes of/reasons for this trend.<br>
>
