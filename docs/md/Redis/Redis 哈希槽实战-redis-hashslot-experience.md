...
2. 一致性哈希分区
	...
	1. 一致性哈希算法中首先有一个哈希函数,哈希函数产生hash值,所有可能的哈希值构成一个哈希空间,哈希空间为[0,2^32-1],这本来是一个"线性"的空间,但是在算法中通过恰当逻辑控制,使其首尾相衔接,也即是0-2^32,这样就构造一个逻辑上的环形空间。
	![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-e57aec29ab734f87863efe8aabde44ae.png)
	2. 节点映射将集群中的各IP节点映射到环上的某个一位置。假设有四个节点Node A, B, C、D,经过ip地址的哈希函数计算(例如:ash(192.168.1.13)) ,它们的位置如下:
	![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/imgd/2021/10/image-682b5b1211214be8a1ab5055131d60b7.png)
	3. 路由规则包括存储(setx)和取值(getx)规则。当需要存储一个<key-value>对时,首先计算键key的hash值: hash(key),这个hash值必然对应于一致性hash环上的某个位置,然后沿着这个值按顺时针找到第一个节点,并将该键值对存储在该节点上.
	...
	![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-e18fe059146a45569ed2471a80e97246.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-d66ab59086524c42a544d5d2137b5d47.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-cba2a12e430a461ea21d1a8543254a1a.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-655a2db1ec3849bc8c41fc06e5048992.png)

![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-ed3f2dc8e30a47d09221ef9e94cc47a0.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-db96af3857d742fbbfa055d8119349ec.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-7c5b6ba8e12340dcafcc6a0304e9dd51.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-fdb56886b62d458ea7313f4793ff9062.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-04aaa9f41dde431492416ae03fcd151a.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-87227ed6982e407db198271c4749812c.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-a96ce3f7b01e47e4b5123f275f75a842.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-17fac9b3268f401ea6d288d2224c1a57.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-dacff31761b34216a238e97b35a9ff16.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-fdcf80b8833c4d3783c048de4ca31cad.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-8381a2d3122a4d3994450b22924483dc.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-57883c9615a04871ab9bb1ffe5c7a3e2.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-56ceb428f891437a9b268c11bc684656.png)

![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-a37c3a457fb94e5d919ba9da4dbb12e8.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-c10cb3c7b1f045cd853bb16f5f53d3fa.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-ba760510f44142548ecdd2f6db1185d2.png)

![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-1b127831a8a541579f5be9b70883d830.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-cb77bc8f0d6445b49f719419c27aa0c1.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-302726e17923416383d3fd6b6603bd25.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-a71a0188d67b4479a599cfbe7801e9a7.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-be8174bdad31455db23c36feae02a88e.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-2a2c7a4c8a2145fbb6b3f9b873a9e717.png)
...
keys *
```
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/10/image-6df851e8084348eeacc67a7fed804b0b.png)
