...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-93a5f850dc5f49c99feb10cd6f9a4381.png)
...
### 分库分表
将数据库分为多个库，多个库抗更多的兵法；将一个表拆分多个表，每个表的数据量保持少一点，提高sql的性能。
