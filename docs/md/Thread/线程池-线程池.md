...
## 线程池业务中的实践
[线程池业务中的实践](https://zhengstars.website/archives/%E7%BA%BF%E7%A8%8B%E6%B1%A0%E4%B8%9A%E5%8A%A1%E4%B8%AD%E7%9A%84%E5%AE%9E%E8%B7%B5)

## 线程池的运行状态
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-041aa48198e6423f870a9941504b9bb1.png)
**生命周期的转换**
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-647d9950251d4b45a172cdbd8d9f7aa4.png)
...
### 线程池的运行原理
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-f212ccf3be1b4d888b20c58b36db6607.png)
...
## AQS
### 介绍
[抽象队列同步器](https://zhengstars.website/archives/aqs)
...
- [CountDownLatch](https://zhengstars.website/archives/countdownlatch)（倒计时器）：可以让某一个线程等到直到倒计时结束，才开始执行。允许多个线程阻塞到一个地方，直到所有线程都执行完毕。
