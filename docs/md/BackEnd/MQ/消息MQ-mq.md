...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-5b0a432fc7d44ef6b2fa4d863b008755.png)


> 使用MQ，一个系统产生一个数据发送到MQ，哪个系统需要数据就去MQ里面消费。这样不需要维护代码，也不需要考虑是否调用成功或者失败问题。

![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-b57b5fb878e143cd94d2dcde090aed30.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-9d3715c4ec5e4de0a0c8d74db625dbb0.png)

> 如果使用 MQ，那么 A 系统连续发送 3 条消息到 MQ 5 毫秒，请求中，总耗时为用户，一个系统从接受到返回响应给用户，总时间长是 3 + 5 = 8 毫秒，对于用户来说，实际上感觉上就是点个按钮，8ms以后就直接返回了

![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-ee039b0dfd6f447da675d0f257995354.png)

### 削峰
1. 某个时间段，请求数据突然暴增5K，但是过了这个时间段，请求又降低了

![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-cc025f62f9fa4140b720209eeec12fb3.png)

> 如果使用MQ，5K请求到MQ，一个系统最多处理2K。系统从MQ慢慢拉取，每次只拉取2K个请求，其他的先暂时积压到MQ中

![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-1f7dd4ff41cc42a28594bec0dd5d3136.png)
...
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-46c3d20f2f9b42c69187551b7b9aa49d.png)
