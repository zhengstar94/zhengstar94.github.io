...
**案例：**
1. 通过top找出cpu高的PID
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-c81ad67e69a84ff4bdd9bd564a0499c5.png)

可以通过ps aux | grep PID更详细看到这个进程是什么项目

2. top -H -pPID 找到CPU占用率比较高的线程tid
如：top -H -p21264
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-824574f48a2a401d91343af33d83ced4.png)

3. 其次将需要的线程ID转换为16进制格式
```printf “%x\n” tid```
如 printf “%x\n” 21276   的十六进制是531c
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/08/image-c6f283b020034a6bacb0ec3c5d2ed260.png)
