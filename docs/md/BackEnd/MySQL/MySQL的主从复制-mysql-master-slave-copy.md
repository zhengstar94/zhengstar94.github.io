...
show master status;
```
![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/09/image-c918b71edb4149b59c7227d1437fd2d9.png)
- 记录下File和Position的值
...
- 如果以下两项为Yes表示配置成功
	- Slave_IO_Running
	- Slave_SQL_Running
	![image.png](https://raw.githubusercontent.com/zhengstar94/zhengstar94.github.io/main/docs/assets/img/2021/09/image-17453a0c91114910ac15afe800fdf1a6.png)
