...
1. Unable use Script to migrate data
2. Only can use APIs of Java to migrate
3. Synchronization time needs to be within half an hour.
4. Need to be stable and without exception。

## Functions Compare

### 1. Use jpa function `saveAll`
...
### 3. Use JDBC Batch Update using PreparedStatement
