...
{% include figure.liquid loading="eager" path="assets/img/2022/08/image-15518330c13640628e48c1681c0f8f14.png" class="img-fluid rounded z-depth-1" zoomable=true width="70%"%}
...
示意图如下：
{% include figure.liquid loading="eager" path="assets/img/2022/08/image-62eca07a65ea44b9b952682f90d6eda7.png" class="img-fluid rounded z-depth-1" zoomable=true width="70%"%}
